...
const GAMES = [
  ...
  { title: 'Quiz Sigo com Fé', cover: '/game-covers/quiz-sigo-com-fe-cover.png', path: '/quiz-sigo-com-fe/index.html', description: 'Uma jornada de perguntas bíblicas para aprender, refletir e celebrar a fé.' },
