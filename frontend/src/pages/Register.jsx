    ...
    <div className="register-page" style={{ minHeight: '100vh', padding: 'clamp(16px,4vw,48px)', background: 'radial-gradient(circle at 8% 12%,#f5ebd2 0,transparent 23%), linear-gradient(145deg,#fbfaf8 0%,#f1f3fa 58%,#fff 100%)' }}>
      ...
      <aside className="register-story" style={{ color: '#231b3a' }}>
        ...
        <div className="faith-collage" style={{ position: 'relative', minHeight: 392, maxWidth: 570, margin: '0 auto 18px' }}>
          <div style={{ position: 'absolute', left: 0, top: 0, width: 112, height: 145, padding: 5, borderRadius: 22, background: '#fff', boxShadow: '0 14px 28px rgba(58,35,82,.18)', transform: 'rotate(-4deg)', zIndex: 3 }}><img src="/registro-verena.png" alt="Membro da comunidade Sigo com Fé" style={{ width: '100%', height: '100%', objectFit: 'cover', objectPosition: '50% 18%', borderRadius: 17 }}/></div>
          <div style={{ position: 'absolute', right: 2, top: 2, width: 158, height: 112, padding: 5, borderRadius: 22, background: '#fff', boxShadow: '0 14px 28px rgba(58,35,82,.18)', transform: 'rotate(4deg)', zIndex: 3 }}><img src="/registro-wender.png" alt="Membro da comunidade Sigo com Fé" style={{ width: '100%', height: '100%', objectFit: 'cover', objectPosition: '50% 28%', borderRadius: 17 }}/></div>
