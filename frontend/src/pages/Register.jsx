      ...
      <div className="card auth-card">
        ...
        <form onSubmit={handleSubmit}>
          <div className="form-group">
            <label><User size={14} style={{ verticalAlign: 'middle', marginRight: '4px' }} />Nome Completo</label>
            <input value={form.full_name} onChange={(e) => setForm({ ...form, full_name: e.target.value })} placeholder="Seu nome completo" required />
          </div>
          <div className="form-group">
          ...
          <div className="form-group">
            <label><Lock size={14} style={{ verticalAlign: 'middle', marginRight: '4px' }} />Senha</label>
          ...
          <div className="form-group">
            ...
            <select value={form.role} onChange={(e) => setForm({ ...form, role: e.target.value })}>
              <option value="member">Membro / Fiel</option>
              <option value="pastor">Pastor / Líder</option>
            </select>
          </div>
        ...
        <p style={{ textAlign: 'center', marginTop: '1.5rem', color: 'var(--gray-500)' }}>
          Já tem conta? <Link to="/login" style={{ color: 'var(--green)', fontWeight: 600 }}>Entrar</Link>
        </p>
      </div>
    </div>
  );
