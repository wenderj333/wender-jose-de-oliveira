      ...
      {questions.map((q, i) => (
        <div key={i} style={{background:'#f9f9f9',borderRadius:12,padding:24,marginBottom:20,border:'1px solid #e0e0e0'}}>
          ...
          <textarea
            ...
            style={{width:'100%',minHeight:100,padding:12,borderRadius:8,border:'1px solid #ccc',fontSize:14}}
          />
        </div>
      ))}
      {saved ? (
        ...
        <button
          ...
          style={{width:'100%',padding:14,background:'#7c3aed',color:'white',border:'none',borderRadius:12,fontSize:16,cursor:'pointer'}}
        >
          {t('reflection.save')}
        </button>
      )}
