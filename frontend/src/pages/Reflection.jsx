...
﻿  return (
    <div style={{maxWidth:720,margin:'0 auto',padding:'0 0 80px',fontFamily:'Segoe UI,sans-serif'}}>
      ...
      <div style={{backgroundImage:'linear-gradient(135deg,rgba(108,63,160,0.75),rgba(45,10,94,0.85)),url(https://images.unsplash.com/photo-1519681393784-d120267933ba?w=1200&q=80)',backgroundSize:'cover',backgroundPosition:'center',padding:'36px 24px 28px',borderRadius:'0 0 32px 32px',marginBottom:28,color:'white',position:'relative',overflow:'hidden'}}>
