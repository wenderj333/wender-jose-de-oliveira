      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
        ...
        {user && (
          <div style={{ display: 'flex', gap: 6 }}>
            <button onClick={handlePublishClick} style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 4, background: 'rgba(168,85,247,0.1)', border: '1px solid rgba(168,85,247,0.3)', borderRadius: 8, padding: '5px 8px', cursor: 'pointer', color: '#9333ea', fontSize: 11, fontWeight: 600 }}>
