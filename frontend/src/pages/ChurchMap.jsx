...
const DEMO_CHURCHES = [
  {
    id: 'demo-1',
    name: 'Igreja Batista Central de Madrid',
  ...
  {
    id: 'demo-3',
    name: 'Assembleia de Deus - Vila Mariana',
    denomination: 'Assembleia de Deus',
    address: 'Av. Paulista, 900',
    city: 'São Paulo',
    country: 'Brasil',
    phone: '+55 11 9876-5432',
    pastor_name: 'Carlos Eduardo Silva',
    member_count: 520,
    latitude: -23.5505,
    longitude: -46.6333,
  },
  {
    id: 'demo-4',
    name: 'Igreja Presbiteriana de Barcelona',
  ...
  {
    id: 'demo-5',
    name: 'Brazilian Christian Fellowship',
    denomination: 'Evangélica',
    address: '42 Baker Street',
    city: 'London',
    country: 'Reino Unido',
    phone: '+44 20 7946 0958',
    pastor_name: 'Marcos Oliveira',
    member_count: 130,
    latitude: 51.5074,
    longitude: -0.1278,
  },
...
export default function ChurchMap() {
  ...
  // Filter demo churches by search query
  ...
  return (
    <div>
      <h2 style={{ color: 'var(--green-dark)', marginBottom: '1.5rem', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
        <MapPin size={24} /> Mapa de Igrejas
      </h2>
      ...
      <form onSubmit={search} className="church-search">
        <div style={{ position: 'relative', flex: 1 }}>
          ...
          <input
            ...
            placeholder="Buscar por cidade, país ou nome..."
            style={{ paddingLeft: '2.5rem' }}
          />
        </div>
        <button type="submit" className="btn btn-green"><Search size={16} /> Buscar</button>
      </form>

      {loading && <p style={{ textAlign: 'center', color: 'var(--gray-500)' }}>Buscando igrejas...</p>}

      {!loading && displayChurches.length === 0 && (
        <div className="card" style={{ textAlign: 'center', padding: '3rem' }}>
          <Church size={48} style={{ color: 'var(--gray-200)', margin: '0 auto 1rem' }} />
          <p style={{ color: 'var(--gray-500)' }}>Nenhuma igreja encontrada para "{searchQuery}". Cadastre a sua!</p>
        </div>
      )}
