...
export default function DuelLanding() {
  ...
  return <main style={{ minHeight: '100vh', padding: '20px 18px 64px', background: 'linear-gradient(150deg,#f8f5ff 0%,#eef5ff 60%,#fff 100%)', color: '#21133e' }}>
    ...
    <section style={{ maxWidth: 830, margin: '0 auto', textAlign: 'center' }}>
      ...
      <figure style={{ margin: '28px auto 0', maxWidth: 830, overflow: 'hidden', borderRadius: 22, boxShadow: '0 18px 42px rgba(56,31,91,.22)', border: '1px solid #d9cbea', background: '#2e174f' }}>
        <img src="/duelo-biblico-perguntas.png" alt="Dois irmãos participando de um duelo de perguntas bíblicas" style={{ display: 'block', width: '100%', height: 'auto' }} />
      </figure>
