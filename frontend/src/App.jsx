...
import {
  ...
  Calendar, Shield, PlayCircle, Sun, Mail, Settings as SettingsIcon
    ...
    <div className="app-container">
      ...
      <header className="topbar">
        ...
        <nav className="nav-scroll desktop-only" style={{display:'flex',alignItems:'center',gap:'2px',marginLeft:'20px'}}>
          ...
          <Link to="/jogos" className={`nav-item ${location.pathname==='/jogos'?'active':''}`} style={{color:'white',textDecoration:'none',padding:'6px 11px',borderRadius:8,fontSize:'0.84rem',display:'flex',alignItems:'center',gap:6}}>

            <PlayCircle size={15}/> Jogos
      ...
      <div className={`modern-layout${isDuelPage ? ' duel-layout' : ''}`}>
        ...
        <aside className="sidebar-left desktop-only" style={{ display: isDuelPage ? 'none' : undefined }}>
          ...
          <div className="menu-group">
            ...
            <Link to="/configuracoes" className={isActive('/configuracoes') || isActive('/settings')}><SettingsIcon size={17}/><span className="nav-text" style={{marginLeft:10}}>Configurações</span></Link>
