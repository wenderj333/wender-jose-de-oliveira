...
export default function DesafioBiblico() {
  ...
  function jogarAleatorio() {
    ...
    const pingInterval = setInterval(() => { if(ws.readyState === 1) ws.send(JSON.stringify({type:'ping'})); }, 10000);
    ws.onclose = () => { clearInterval(pingInterval); if(wsRef.current === ws) setEsperando(false); };
  }
