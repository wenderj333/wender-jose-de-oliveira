    ...
    return (
      ...
      <Routes>
        ...
        <Route path="/perfil/:userId" element={<Profile />} />
            <Route path="/ver-perfil/:userId" element={<ProfileView />} /><Route path="/configuracoes" element={<Settings />} /><Route path="/settings" element={<Settings />} /><Route path="/tlogin" element={<TokenLogin />} />
