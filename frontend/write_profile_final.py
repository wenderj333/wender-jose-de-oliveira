...
export default function Profile() {
  ...
  const tabs = [["all", t("profile.allPosts","Todas")], ["foto", "Fotos"], ["video", "Videos"], ["galeria", "Galeria"]];
        ...
        <header style={{ display: "flex", alignItems: "center", marginBottom: "30px", gap: "30px", flexWrap: "wrap" }}>
          ...
          <section style={{ flex: 1, minWidth: 200 }}>
            ...
            <div style={{ display: "flex", gap: "24px", marginBottom: "12px" }}>
              ...
              <span><strong>0</strong> irmaos</span>
            </div>
...
open("src/pages/Profile.jsx", "w", encoding="utf-8").write(content)
print("Feito!")
