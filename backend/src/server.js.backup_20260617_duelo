...
const perguntasDuelo = {
  pt: [
    ...
    {q:"Qual foi o primeiro milagre de Jesus?",a:["Curou cego","Ressuscitou Lazaro","Agua em vinho","Alimentou 5000"],c:2},
    {q:"Quem escreveu a maioria dos Salmos?",a:["Salomao","Moises","Davi","Asafe"],c:2},
    {q:"Quantos dias choveu no Diluvio?",a:["7 dias","12 dias","40 dias","100 dias"],c:2},
    {q:"Quem ungiu Davi como rei?",a:["Eli","Nata","Samuel","Gade"],c:2}
  ],
  en: [
    ...
    {q:"Who wrote most Psalms?",a:["Solomon","Moses","David","Asaph"],c:2},
  ...
  es: [
    {q:"Quien fue el primer hombre?",a:["Noe","Adan","Abraham","Moises"],c:1},
    {q:"Quien construyo el arca?",a:["Abraham","Noe","Lot","Isaac"],c:1},
    {q:"Donde nacio Jesus?",a:["Jerusalem","Belen","Nazaret","Roma"],c:1},
    ...
    {q:"Cual fue el primer milagro de Jesus?",a:["Sano ciego","Resucito Lazaro","Agua en vino","Alimento 5000"],c:2},
    {q:"Quien escribio la mayoria de los Salmos?",a:["Salomon","Moises","David","Asaf"],c:2},
    {q:"Cuantos dias llovo en el Diluvio?",a:["7 dias","12 dias","40 dias","100 dias"],c:2},
    {q:"Quien ungio a David como rey?",a:["Eli","Natan","Samuel","Gad"],c:2}
  ],
  fr: [
    {q:"Qui etait le premier homme?",a:["Noe","Adam","Abraham","Moise"],c:1},
    {q:"Qui a construit l arche?",a:["Abraham","Noe","Lot","Isaac"],c:1},
    {q:"Ou est ne Jesus?",a:["Jerusalem","Bethleem","Nazareth","Rome"],c:1},
    ...
    {q:"Qui a ecrit la plupart des Psaumes?",a:["Salomon","Moise","David","Asaph"],c:2},
    {q:"Combien de jours a-t-il plu pendant le Deluge?",a:["7 jours","12 jours","40 jours","100 jours"],c:2},
    {q:"Qui a oint David comme roi?",a:["Eli","Nathan","Samuel","Gad"],c:2}
  ],
  de: [
    {q:"Wer war der erste Mensch?",a:["Noah","Adam","Abraham","Mose"],c:1},
    ...
    {q:"Wer schrieb die meisten Psalmen?",a:["Salomo","Mose","David","Asaph"],c:2},
    {q:"Wie viele Tage regnete es bei der Sintflut?",a:["7 Tage","12 Tage","40 Tage","100 Tage"],c:2},
    {q:"Wer salbte David zum Koenig?",a:["Eli","Natan","Samuel","Gad"],c:2}
  ],
  ro: [
    {q:"Cine a fost primul om?",a:["Noe","Adam","Avraam","Moise"],c:1},
    {q:"Cine a construit arca?",a:["Avraam","Noe","Lot","Isaac"],c:1},
    {q:"Unde s-a nascut Isus?",a:["Ierusalim","Betleem","Nazaret","Roma"],c:1},
    ...
    {q:"Cate zile a plouat in Potop?",a:["7 zile","12 zile","40 de zile","100 de zile"],c:2},
